...
void Init_OLED(){
	...
	OLED_ShowChinese(0,3,0,16);		//你
	OLED_ShowChinese(18,3,1,16);	//好
	OLED_ShowChinese(36,3,2,16);	//,
	OLED_ShowChinese(54,3,3,16);	//我
	OLED_ShowChinese(72,3,4,16);	//是
	OLED_ShowChinese(90,3,5,16);	//小
	OLED_ShowChinese(108,3,6,16);	//植
	usleep(500000);
}
