...
proc create_root_design { parentCell } {
  ...
  set dht11_data [ create_bd_port -dir IO dht11_data ]
  set res [ create_bd_port -dir O res ]
  set rx_asr [ create_bd_port -dir I rx_asr ]
  set rx_jq [ create_bd_port -dir I rx_jq ]
  set rx_pm [ create_bd_port -dir I rx_pm ]
  set sclk [ create_bd_port -dir O sclk ]
  set sda [ create_bd_port -dir O sda ]
  set tx_asr [ create_bd_port -dir I tx_asr ]
  set tx_tts [ create_bd_port -dir O tx_tts ]

  # Create instance: ASR, and set properties
  set ASR [ create_bd_cell -type ip -vlnv xilinx.com:user:ASR_rcv:1.0 ASR ]

  # Create instance: ASR_UART_RX, and set properties
  set ASR_UART_RX [ create_bd_cell -type ip -vlnv xilinx.com:user:UART_xfh:1.0 ASR_UART_RX ]

  # Create instance: DHT11, and set properties
  set DHT11 [ create_bd_cell -type ip -vlnv xilinx.com:user:DHT11_IP:1.0 DHT11 ]

  # Create instance: JQ, and set properties
  set JQ [ create_bd_cell -type ip -vlnv xilinx.com:user:jiaquan:1.0 JQ ]

  # Create instance: JQ_UART_RX, and set properties
  set JQ_UART_RX [ create_bd_cell -type ip -vlnv xilinx.com:user:UART_xfh:1.0 JQ_UART_RX ]

  # Create instance: OLED, and set properties
  set OLED [ create_bd_cell -type ip -vlnv xilinx.com:user:SPI_MOSI:1.0 OLED ]

  # Create instance: PM, and set properties
  set PM [ create_bd_cell -type ip -vlnv xilinx.com:user:PM:1.0 PM ]

  # Create instance: PM_UART_RX, and set properties
  set PM_UART_RX [ create_bd_cell -type ip -vlnv xilinx.com:user:UART_xfh:1.0 PM_UART_RX ]

  # Create instance: TTS, and set properties
  set TTS [ create_bd_cell -type ip -vlnv xilinx.com:user:UART_LITE_TX:1.0 TTS ]
...
CONFIG.PCW_ACT_QSPI_PERIPHERAL_FREQMHZ {200.000000} CONFIG.PCW_ACT_SDIO_PERIPHERAL_FREQMHZ {100.000000} \
...
CONFIG.PCW_CLK0_FREQ {100000000} CONFIG.PCW_CLK1_FREQ {50000000} \
...
CONFIG.PCW_DCI_PERIPHERAL_DIVISOR0 {35} CONFIG.PCW_DCI_PERIPHERAL_DIVISOR1 {3} \
CONFIG.PCW_DCI_PERIPHERAL_FREQMHZ {10.159} CONFIG.PCW_DDRPLL_CTRL_FBDIV {32} \
CONFIG.PCW_DDR_DDR_PLL_FREQMHZ {1066.667} CONFIG.PCW_DDR_HPRLPR_QUEUE_PARTITION {HPR(0)/LPR(32)} \
...
CONFIG.PCW_EN_EMIO_TRACE {0} CONFIG.PCW_EN_EMIO_TTC0 {1} \
...
CONFIG.PCW_EN_TRACE {0} CONFIG.PCW_EN_TTC0 {1} \
...
CONFIG.PCW_FCLK1_PERIPHERAL_DIVISOR0 {20} CONFIG.PCW_FCLK1_PERIPHERAL_DIVISOR1 {1} \
CONFIG.PCW_FCLK2_PERIPHERAL_CLKSRC {IO PLL} CONFIG.PCW_FCLK2_PERIPHERAL_DIVISOR0 {20} \
CONFIG.PCW_FCLK2_PERIPHERAL_DIVISOR1 {1} CONFIG.PCW_FCLK3_PERIPHERAL_CLKSRC {IO PLL} \
CONFIG.PCW_FCLK3_PERIPHERAL_DIVISOR0 {20} CONFIG.PCW_FCLK3_PERIPHERAL_DIVISOR1 {1} \
...
CONFIG.PCW_FPGA_FCLK0_ENABLE {1} CONFIG.PCW_FPGA_FCLK1_ENABLE {0} \
...
CONFIG.PCW_I2C0_BASEADDR {0xE0004000} CONFIG.PCW_I2C0_GRP_INT_ENABLE {0} \
CONFIG.PCW_I2C0_GRP_INT_IO {<Select>} CONFIG.PCW_I2C0_HIGHADDR {0xE0004FFF} \
...
CONFIG.PCW_I2C_PERIPHERAL_FREQMHZ {25} CONFIG.PCW_I2C_RESET_ENABLE {1} \
...
CONFIG.PCW_MIO_10_IOTYPE {LVCMOS 3.3V} CONFIG.PCW_MIO_10_PULLUP {disabled} \
...
CONFIG.PCW_MIO_12_IOTYPE {LVCMOS 3.3V} CONFIG.PCW_MIO_12_PULLUP {disabled} \
...
CONFIG.PCW_MIO_14_IOTYPE {LVCMOS 3.3V} CONFIG.PCW_MIO_14_PULLUP {disabled} \
...
CONFIG.PCW_MIO_45_SLEW {fast} CONFIG.PCW_MIO_46_DIRECTION {in} \
CONFIG.PCW_MIO_46_IOTYPE {LVCMOS 1.8V} CONFIG.PCW_MIO_46_PULLUP {disabled} \
CONFIG.PCW_MIO_46_SLEW {slow} CONFIG.PCW_MIO_47_DIRECTION {in} \
...
CONFIG.PCW_MIO_51_IOTYPE {LVCMOS 1.8V} CONFIG.PCW_MIO_51_PULLUP {disabled} \
...
CONFIG.PCW_MIO_52_SLEW {fast} CONFIG.PCW_MIO_53_DIRECTION {inout} \
CONFIG.PCW_MIO_53_IOTYPE {LVCMOS 1.8V} CONFIG.PCW_MIO_53_PULLUP {disabled} \
CONFIG.PCW_MIO_53_SLEW {fast} CONFIG.PCW_MIO_5_DIRECTION {inout} \
...
CONFIG.PCW_MIO_8_SLEW {slow} CONFIG.PCW_MIO_9_DIRECTION {inout} \
...
CONFIG.PCW_MIO_TREE_PERIPHERALS {GPIO#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#UART 1#UART 1#GPIO#GPIO#Enet 0#Enet 0} CONFIG.PCW_MIO_TREE_SIGNALS {gpio[0]#qspi0_ss_b#qspi0_io[0]#qspi0_io[1]#qspi0_io[2]#qspi0_io[3]#qspi0_sclk#gpio[7]#gpio[8]#gpio[9]#gpio[10]#gpio[11]#gpio[12]#gpio[13]#gpio[14]#gpio[15]#tx_clk#txd[0]#txd[1]#txd[2]#txd[3]#tx_ctl#rx_clk#rxd[0]#rxd[1]#rxd[2]#rxd[3]#rx_ctl#data[4]#dir#stp#nxt#data[0]#data[1]#data[2]#data[3]#clk#data[5]#data[6]#data[7]#clk#cmd#data[0]#data[1]#data[2]#data[3]#wp#cd#tx#rx#gpio[50]#gpio[51]#mdc#mdio} \
...
CONFIG.PCW_P2F_USB1_INTR {0} CONFIG.PCW_PACKAGE_DDR_BOARD_DELAY0 {0.063} \
CONFIG.PCW_PACKAGE_DDR_BOARD_DELAY1 {0.062} CONFIG.PCW_PACKAGE_DDR_BOARD_DELAY2 {0.065} \
CONFIG.PCW_PACKAGE_DDR_BOARD_DELAY3 {0.083} CONFIG.PCW_PACKAGE_DDR_DQS_TO_CLK_DELAY_0 {-0.007} \
CONFIG.PCW_PACKAGE_DDR_DQS_TO_CLK_DELAY_1 {-0.010} CONFIG.PCW_PACKAGE_DDR_DQS_TO_CLK_DELAY_2 {-0.006} \
CONFIG.PCW_PACKAGE_DDR_DQS_TO_CLK_DELAY_3 {-0.048} CONFIG.PCW_PACKAGE_NAME {clg484} \
...
CONFIG.PCW_SDIO_PERIPHERAL_DIVISOR0 {10} CONFIG.PCW_SDIO_PERIPHERAL_FREQMHZ {100} \
...
CONFIG.PCW_S_AXI_HP0_DATA_WIDTH {64} CONFIG.PCW_S_AXI_HP0_FREQMHZ {10} \
CONFIG.PCW_S_AXI_HP0_ID_WIDTH {6} CONFIG.PCW_S_AXI_HP1_DATA_WIDTH {64} \
CONFIG.PCW_S_AXI_HP1_FREQMHZ {10} CONFIG.PCW_S_AXI_HP1_ID_WIDTH {6} \
...
CONFIG.PCW_UIPARAM_DDR_BL {8} CONFIG.PCW_UIPARAM_DDR_BOARD_DELAY0 {0.0} \
...
CONFIG.PCW_UIPARAM_DDR_DQS_TO_CLK_DELAY_1 {0.0} CONFIG.PCW_UIPARAM_DDR_DQS_TO_CLK_DELAY_2 {0.0} \
...
CONFIG.PCW_WDT_PERIPHERAL_FREQMHZ {133.333333} CONFIG.PCW_WDT_WDT_IO {<Select>} \
  ...
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M00_AXI [get_bd_intf_pins TTS/uart_tx] [get_bd_intf_pins processing_system7_0_axi_periph/M00_AXI]
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M01_AXI [get_bd_intf_pins OLED/SPI_MOSI] [get_bd_intf_pins processing_system7_0_axi_periph/M01_AXI]
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M02_AXI [get_bd_intf_pins DHT11/S00_AXI] [get_bd_intf_pins processing_system7_0_axi_periph/M02_AXI]
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M03_AXI [get_bd_intf_pins ASR/S00_AXI] [get_bd_intf_pins processing_system7_0_axi_periph/M03_AXI]
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M04_AXI [get_bd_intf_pins ASR_UART_RX/S00_AXI] [get_bd_intf_pins processing_system7_0_axi_periph/M04_AXI]
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M05_AXI [get_bd_intf_pins JQ/S00_AXI] [get_bd_intf_pins processing_system7_0_axi_periph/M05_AXI]
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M06_AXI [get_bd_intf_pins JQ_UART_RX/S00_AXI] [get_bd_intf_pins processing_system7_0_axi_periph/M06_AXI]
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M07_AXI [get_bd_intf_pins PM/S00_AXI] [get_bd_intf_pins processing_system7_0_axi_periph/M07_AXI]
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M08_AXI [get_bd_intf_pins PM_UART_RX/S00_AXI] [get_bd_intf_pins processing_system7_0_axi_periph/M08_AXI]

  # Create port connections
  connect_bd_net -net Net [get_bd_ports dht11_data] [get_bd_pins DHT11/dht11_data]
  connect_bd_net -net SPI_MOSI_0_cs [get_bd_ports cs] [get_bd_pins OLED/cs]
  connect_bd_net -net SPI_MOSI_0_dc [get_bd_ports dc] [get_bd_pins OLED/dc]
  connect_bd_net -net SPI_MOSI_0_res [get_bd_ports res] [get_bd_pins OLED/res]
  connect_bd_net -net SPI_MOSI_0_sclk [get_bd_ports sclk] [get_bd_pins OLED/sclk]
  connect_bd_net -net SPI_MOSI_0_sda [get_bd_ports sda] [get_bd_pins OLED/sda]
  connect_bd_net -net UART_LITE_TX_0_tx [get_bd_ports tx_tts] [get_bd_pins TTS/tx]
  connect_bd_net -net UART_xfh_0_message [get_bd_pins ASR/rcv_msg] [get_bd_pins ASR_UART_RX/message]
  connect_bd_net -net UART_xfh_0_message1 [get_bd_pins JQ/message_mid1] [get_bd_pins JQ_UART_RX/message]
  connect_bd_net -net UART_xfh_0_over [get_bd_pins ASR/over] [get_bd_pins ASR_UART_RX/over]
  connect_bd_net -net UART_xfh_0_over1 [get_bd_pins JQ/over] [get_bd_pins JQ_UART_RX/over]
  connect_bd_net -net UART_xfh_1_message [get_bd_pins PM/message_mid] [get_bd_pins PM_UART_RX/message]
  connect_bd_net -net UART_xfh_1_over [get_bd_pins PM/over] [get_bd_pins PM_UART_RX/over]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins ASR/s00_axi_aclk] [get_bd_pins ASR_UART_RX/s00_axi_aclk] [get_bd_pins DHT11/s00_axi_aclk] [get_bd_pins JQ/s00_axi_aclk] [get_bd_pins JQ_UART_RX/s00_axi_aclk] [get_bd_pins OLED/spi_mosi_aclk] [get_bd_pins PM/s00_axi_aclk] [get_bd_pins PM_UART_RX/s00_axi_aclk] [get_bd_pins TTS/uart_tx_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0_axi_periph/ACLK] [get_bd_pins processing_system7_0_axi_periph/M00_ACLK] [get_bd_pins processing_system7_0_axi_periph/M01_ACLK] [get_bd_pins processing_system7_0_axi_periph/M02_ACLK] [get_bd_pins processing_system7_0_axi_periph/M03_ACLK] [get_bd_pins processing_system7_0_axi_periph/M04_ACLK] [get_bd_pins processing_system7_0_axi_periph/M05_ACLK] [get_bd_pins processing_system7_0_axi_periph/M06_ACLK] [get_bd_pins processing_system7_0_axi_periph/M07_ACLK] [get_bd_pins processing_system7_0_axi_periph/M08_ACLK] [get_bd_pins processing_system7_0_axi_periph/S00_ACLK] [get_bd_pins rst_processing_system7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_processing_system7_0_100M/ext_reset_in]
  connect_bd_net -net rst_processing_system7_0_100M_interconnect_aresetn [get_bd_pins processing_system7_0_axi_periph/ARESETN] [get_bd_pins rst_processing_system7_0_100M/interconnect_aresetn]
  connect_bd_net -net rst_processing_system7_0_100M_peripheral_aresetn [get_bd_pins ASR/s00_axi_aresetn] [get_bd_pins ASR_UART_RX/s00_axi_aresetn] [get_bd_pins DHT11/s00_axi_aresetn] [get_bd_pins JQ/s00_axi_aresetn] [get_bd_pins JQ_UART_RX/s00_axi_aresetn] [get_bd_pins OLED/spi_mosi_aresetn] [get_bd_pins PM/s00_axi_aresetn] [get_bd_pins PM_UART_RX/s00_axi_aresetn] [get_bd_pins TTS/uart_tx_aresetn] [get_bd_pins processing_system7_0_axi_periph/M00_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M01_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M02_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M03_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M04_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M05_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M06_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M07_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M08_ARESETN] [get_bd_pins processing_system7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_processing_system7_0_100M/peripheral_aresetn]
  connect_bd_net -net rx_1 [get_bd_ports rx_asr] [get_bd_pins ASR_UART_RX/rx]
  connect_bd_net -net rx_2 [get_bd_ports rx_jq] [get_bd_pins JQ_UART_RX/rx]
  connect_bd_net -net rx_3 [get_bd_ports rx_pm] [get_bd_pins PM_UART_RX/rx]
  connect_bd_net -net tx_1 [get_bd_ports tx_asr] [get_bd_pins ASR/tx]

  # Create address segments
  create_bd_addr_seg -range 0x10000 -offset 0x43C30000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs ASR/S00_AXI/S00_AXI_reg] SEG_ASR_rcv_0_S00_AXI_reg
  create_bd_addr_seg -range 0x10000 -offset 0x43C20000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs DHT11/S00_AXI/S00_AXI_reg] SEG_DHT11_IP_0_S00_AXI_reg
  create_bd_addr_seg -range 0x10000 -offset 0x43C70000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs PM/S00_AXI/S00_AXI_reg] SEG_PM_0_S00_AXI_reg
  create_bd_addr_seg -range 0x10000 -offset 0x43C10000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs OLED/SPI_MOSI/SPI_MOSI_reg] SEG_SPI_MOSI_0_SPI_MOSI_reg
  create_bd_addr_seg -range 0x10000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs TTS/uart_tx/uart_tx_reg] SEG_UART_LITE_TX_0_uart_tx_reg
  create_bd_addr_seg -range 0x10000 -offset 0x43C40000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs ASR_UART_RX/S00_AXI/S00_AXI_reg] SEG_UART_xfh_0_S00_AXI_reg
  create_bd_addr_seg -range 0x10000 -offset 0x43C60000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs JQ_UART_RX/S00_AXI/S00_AXI_reg] SEG_UART_xfh_0_S00_AXI_reg1
  create_bd_addr_seg -range 0x10000 -offset 0x43C80000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs PM_UART_RX/S00_AXI/S00_AXI_reg] SEG_UART_xfh_1_S00_AXI_reg
  create_bd_addr_seg -range 0x10000 -offset 0x43C50000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs JQ/S00_AXI/S00_AXI_reg] SEG_jiaquan_0_S00_AXI_reg
