...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = ASR_rcv
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = ASR
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = UART_xfh
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = ASR_UART_RX
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = DHT11_IP
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = DHT11
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = jiaquan
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = JQ
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = UART_xfh
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = JQ_UART_RX
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = SPI_MOSI
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = OLED
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = PM
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = PM
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = UART_xfh
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = PM_UART_RX
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = UART_LITE_TX
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = TTS
END
